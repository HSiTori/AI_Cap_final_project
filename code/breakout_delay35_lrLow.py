...
# ### 參考 keras 那篇 DQN breakout，有稍微修改了一下步數之類的參數，做小規模測試
...
path = 'delay35/output_delay35.txt'
f = open(path, 'w')
...
while True:  # Run until solved
    ...
    f.write('\n')
    model.save('delay35/my_model_delay35.h5')
    episode_count += 1
    ...
    if running_reward > 40:  # Condition to consider the task solved
        ...
        break
f.close()
new_model = tf.keras.models.load_model('delay35/my_model_delay35.h5')
new_model.summary()